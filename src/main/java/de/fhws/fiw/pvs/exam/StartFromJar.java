...
public class StartFromJar {
    public static void main(final String[] args) throws Exception {
        ...
        context.addServletMappingDecoded("/softskills/*", "jersey-container-servlet");
        tomcat.start();
    ...
    private static File getJarFileOfThisProject()
    {
        ...
        if (fileOfClass.isFile()) {
            ...
            throw new IllegalStateException("Class " + StartFromJar.class.getCanonicalName() + " is not in a JAR file");
        }
    }
}